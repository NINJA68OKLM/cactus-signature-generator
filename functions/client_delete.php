...
$requete= "DELETE FROM employes WHERE id='".$_COOKIE['idd']."' AND nom='".$_COOKIE['nom_'.$i]."' AND prenom='".$_COOKIE['prenom_'.$i]."' AND fonction='".$_COOKIE['fonction_'.$i]."' AND idd='".$_COOKIE['idd_'.$i]."'";
$result = $conn->query($requete);
echo $requete;
// 
